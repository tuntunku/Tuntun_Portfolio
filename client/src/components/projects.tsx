      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Here are some of my recent academic and personal projects that showcase my technical skills and creativity
          </p>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech) => (
                    <span 
                      key={tech}
                      className={`px-3 py-2 rounded-xl text-xs font-medium glass-card hover:scale-105 transform transition-all duration-200 ${project.techColors[tech as keyof typeof project.techColors]}`}
